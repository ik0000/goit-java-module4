package com.goit.module4.unitConverter;
    ...
    public class Runner {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("0 C should be 32 F, let's see the answer ==> "+ Converter.convertUtil(new Celsius(0))+ " F. Looks ok!");
            System.out.println("32 F should be 0 C, let's see the answer ==> "+ Converter.convertUtil(new Farenheit(32))+" C. Looks ok!");
